      ...
      <div class="container">
        <div class="col-lg-9">
          ...
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="#pencarian">Permintaan Update Informasi</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
        <div class="col-lg-1">
        ...
        <div class="col-lg-2">
          <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse">
              <p class="nav navbar-nav">logged in as admin <?php $cookie=$this->session->userdata('idAnggotaTLPI');echo get_username($cookie);?></p>
            </div><!--/.nav-collapse -->
          </div>
        </div>
      </div>
